...
def build_insights_index():
    ...
    insights = [
        ("Sales Enablement Tools: What the Job Data Shows",
         ...
         "We analyzed 1,500+ enablement job postings to find which tools companies require. Content management, conversation intelligence, and readiness platforms ranked by real demand."),
    ]
...
def build_insight_sales_enablement_tools_job_data():
    ...
    description = (
        "Analysis of 1,500+ enablement job postings reveals the tools companies require."
        " Highspot, Seismic, Gong, and the stack that wins."
    )
    ...
    <div class="salary-header-inner">
        ...
        <p>By Rome Thorndike | April 12, 2026</p>
        <p>1,500+ job postings analyzed. Here are the tools companies require from enablement hires.</p>
    </div>
</div>
<div class="salary-content">
    <h2>The Tools That Show Up in Job Descriptions</h2>
    <p>Every sales enablement job posting tells you something about the company's tech stack. When a company lists Highspot or Seismic as a requirement, they're telling you what they've already bought and need someone to run. When they list Gong or Chorus, they're telling you conversation intelligence is part of the enablement function, not just sales ops.</p>
    ...
    <p>Showpad rounds out the top three at 5.3% of mentions. It's most common in mid-market postings and European-headquartered companies. Beyond these three, content management tool mentions fragment across dozens of smaller players. Guru, Bloomfire, and SharePoint each appear in fewer than 2% of postings.</p>
    <p>The data points in one direction: if you're building an enablement career, you need hands-on experience with at least one of Highspot or Seismic. Proficiency in both puts you in a strong position for nearly any content-management-focused enablement role.</p>
    ...
    <p>The readiness category has an LMS problem. Many companies still run enablement training through generic learning management systems like Cornerstone, SAP Litmos, or Docebo. These tools appeared in 8.3% of enablement postings collectively, but they aren't purpose-built for sales. Enablement teams that inherit a generic LMS spend most of their time working around its limitations instead of delivering training.</p>
    ...
    <p>Based on what we see in job postings, here's how companies typically stack their enablement tools by size.</p>

    <h3>Startups and SMBs (Under 200 Employees)</h3>
    <p>Most companies this size don't have dedicated enablement headcount. When they do, the role is a generalist who manages everything from onboarding to content. The typical stack is lightweight: Google Drive or Notion for content, Gong for call coaching, and a basic LMS or no formal training platform at all. Total tool spend: $500-$2,000/month.</p>
...
'''
    ...
    faq_pairs = [
        ...
        ("How much do companies spend on enablement tools?",
         "It varies widely by company size. SMBs typically spend $500-$2,000/month on enablement tools. Mid-market companies spend $5,000-$25,000/month. Enterprise organizations can spend $50,000-$200,000+ monthly across content management, conversation intelligence, training, and analytics platforms."),
...
def build_top_voices():
    ...
    <div class="methodology-content">
        ...
        <ul>
            <li><strong>Topic relevance</strong> (required): Must actively contribute to sales enablement or revenue enablement strategy, tooling, or education.</li>
            ...
            <li><strong>Content frequency</strong> (25%): Regular posting cadence with minimum 2+ posts per month on enablement-specific topics.</li>
        ...
        <p>This list is updated annually. <a href="/newsletter/">Subscribe to SEnablers</a> to get notified when we refresh the rankings.</p>
    </div>
</details>'''

    voices_css = '''<style>
    .voices-hero { text-align: center; padding: 3rem 1.5rem 2rem; max-width: 800px; margin: 0 auto; }
    .voices-hero .eyebrow { color: var(--se-accent); font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 0.75rem; }
    .voices-hero h1 { font-size: clamp(1.75rem, 4vw, 2.5rem); letter-spacing: -0.5px; margin-bottom: 0.75rem; color: var(--se-text-primary); }
    .voices-subtitle { font-size: 1.1rem; color: var(--se-text-secondary); margin-bottom: 0.5rem; }
    .voices-meta { font-size: 0.85rem; color: var(--se-text-secondary); }
    .voices-content { max-width: 800px; margin: 0 auto; padding: 0 1.5rem 3rem; }
    .voice-methodology { margin-bottom: 2rem; border: 1px solid var(--se-border); border-radius: 12px; background: var(--se-bg-surface); }
    .voice-methodology summary { padding: 1rem 1.25rem; cursor: pointer; font-size: 0.95rem; color: var(--se-text-primary); font-weight: 600; }
    .voice-methodology summary:hover { color: var(--se-accent); }
    .methodology-content { padding: 0 1.25rem 1.25rem; font-size: 0.9rem; color: var(--se-text-secondary); line-height: 1.7; }
    .methodology-content ul { padding-left: 1.25rem; margin: 0.75rem 0; }
    .methodology-content li { margin-bottom: 0.5rem; }
    .voices-jump-nav { display: flex; flex-wrap: wrap; gap: 0.25rem; margin-bottom: 2rem; padding: 0.75rem; background: var(--se-bg-surface); border: 1px solid var(--se-border); border-radius: 12px; }
    .voice-jump-link { font-size: 0.75rem; padding: 0.25rem 0.5rem; border-radius: 6px; color: var(--se-text-secondary); text-decoration: none; transition: background 0.15s, color 0.15s; }
    .voice-jump-link:hover { background: var(--se-accent); color: #fff; }
    .voices-section-heading { font-size: 1.3rem; margin-bottom: 0.5rem; padding-bottom: 0.5rem; border-bottom: 2px solid var(--se-accent); color: var(--se-text-primary); }
    .voices-grid { display: flex; flex-direction: column; gap: 1rem; margin-bottom: 2.5rem; }
    .voice-card { border: 1px solid var(--se-border); border-radius: 12px; background: #fff; padding: 1.25rem; transition: border-color 0.2s, box-shadow 0.2s; }
    .voice-card:hover { border-color: var(--se-accent); box-shadow: 0 2px 12px rgba(220,38,38,0.08); }
    .voice-card-header { display: flex; align-items: flex-start; gap: 0.75rem; }
    .voice-rank, .voice-rank-top { font-weight: 700; font-size: 1.1rem; min-width: 2.5rem; text-align: center; flex-shrink: 0; padding-top: 0.15rem; color: var(--se-text-tertiary); }
    .voice-rank-top { color: var(--se-accent); font-size: 1.25rem; }
    .voice-card-info { flex: 1; min-width: 0; }
    .voice-name { font-size: 1.1rem; font-weight: 600; margin: 0 0 0.25rem; line-height: 1.3; }
    .voice-name a { color: var(--se-text-primary); text-decoration: none; }
    .voice-name a:hover { color: var(--se-accent); }
    .voice-title { font-size: 0.85rem; color: var(--se-text-secondary); margin: 0 0 0.5rem; }
    .voice-tags { display: flex; flex-wrap: wrap; gap: 0.35rem; }
    .voice-tag { font-size: 0.7rem; padding: 0.15rem 0.5rem; border-radius: 999px; background: rgba(220,38,38,0.08); color: var(--se-accent); font-weight: 500; }
    .voice-linkedin-btn { flex-shrink: 0; display: flex; align-items: center; justify-content: center; width: 2.25rem; height: 2.25rem; border-radius: 6px; color: var(--se-text-tertiary); text-decoration: none; transition: color 0.15s, background 0.15s; }
    .voice-linkedin-btn:hover { color: #0077B5; background: rgba(0,119,181,0.1); }
    .voice-bio { margin: 0.75rem 0 0; font-size: 0.9rem; color: var(--se-text-secondary); line-height: 1.7; padding-left: calc(2.5rem + 0.75rem); }
    .voices-share-cta { text-align: center; padding: 2rem 1.5rem; max-width: 600px; margin: 0 auto; }
    .voices-share-cta h2 { font-size: 1.3rem; margin-bottom: 0.5rem; color: var(--se-text-primary); }
    .voices-share-cta p { color: var(--se-text-secondary); margin-bottom: 0.5rem; }
    ...
    <div class="voices-content">
        ...
        <p style="color: var(--se-text-secondary); margin-bottom: 1rem;">The most recognized and influential voices shaping sales enablement today.</p>
        <div class="voices-grid">{leaders_html}</div>
        <h2 class="voices-section-heading">Rising Voices (11-25)</h2>
        <p style="color: var(--se-text-secondary); margin-bottom: 1rem;">Practitioners and thought leaders gaining momentum in the enablement community.</p>
